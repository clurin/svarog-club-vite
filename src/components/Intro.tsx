    ...
    return (
        <div className="relative w-full h-[570px]">
            <img
                ...
                alt="Intro"
                className="absolute inset-0 w-full h-full object-cover md:hidden brightness-90"
            />
            <img
                src="/images/intro/intro-desktop-image.png"
                alt="Intro"
                className="absolute inset-0 w-full h-full object-cover hidden md:block brightness-90"
            />
            ...
            <div className="flex flex-col items-center absolute top-12 left-1/2 -translate-x-1/2">
                <img
                    ...
                    height={150}
                />
                <h1 className="tracking-tight whitespace-nowrap pt-10 md:text-xl text-base text-main-red"
                ...
                <p className="text-3xl md:text-nowrap md:text-4xl text-center mt-6 text-white bg-black p-2 md:p-5">Пробное занятие бесплатно</p>
            </div>
